...
function StatusIcon(props) {
  switch (props.status) {
    case 'online':
      return (
        <Icon fontSize="large" className="block text-32 text-green bg-white rounded-full">
          check_circle
        </Icon>
      );
    case 'away':
    ...
    case 'do-not-disturb':
      return (
        <Icon fontSize="large" className="block text-32 text-red bg-white rounded-full">
